                ...
                <ul class="pagination">
                    ...
                    <?php if($paginator->onFirstPage()): ?>
                        <li class="page-item disabled" aria-disabled="true" aria-label="<?php echo app('translator')->get('pagination.previous'); ?>">
                            <a class="page-link" tabindex="-1" aria-disabled="true">Sebelumnya</a>
                        </li>
                    <?php else: ?>
                        <li class="page-item">
                            <a class="page-link" href="<?php echo e($paginator->previousPageUrl()); ?>" tabindex="-1" aria-label="<?php echo app('translator')->get('pagination.previous'); ?>">Sebelumnya</a>
                        </li>
                    <?php endif; ?>
                    ...
                    <?php if($paginator->hasMorePages()): ?>
                        <li class="page-item">
                            <a class="page-link" href="<?php echo e($paginator->nextPageUrl()); ?>" tabindex="-1" aria-label="<?php echo app('translator')->get('pagination.next'); ?>">Selanjutnya</a>
                        </li>
                    <?php else: ?>
                        <li class="page-item disabled" aria-disabled="true" aria-label="<?php echo app('translator')->get('pagination.next'); ?>">
                            <a class="page-link"tabindex="-1" aria-disabled="true">Selanjutnya</a>
                        </li>
                    <?php endif; ?>
                </ul>
            </div>
...
<?php /**PATH D:\Laravel\New folder (2)\resources\views/vendor/pagination/bootstrap-5.blade.php ENDPATH**/ ?>